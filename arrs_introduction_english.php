...
<h3 class="headerstyle">Association of Road Racing Statisticians / Goals</h3>
<P><? ini_set('include_path',$_SERVER['DOCUMENT_ROOT'].'/folder_path'); readfile($goals); ?></p>

<h3 class="headerstyle">Founding members</h3>
...
<h3 class="headerstyle">ARRS Coordinator</h3>
<P><? ini_set('include_path',$_SERVER['DOCUMENT_ROOT'].'/folder_path'); readfile($coordinator); ?></p>

<h3 class="headerstyle">ARRS membership</h3>
